...
ATENÇÃO — isso define QUAIS ARQUIVOS gerar: rendimento e resgate de aplicação financeira NÃO entram no arquivo de Lançamentos (lanctos) como lançamento manual. O caminho certo são DOIS arquivos: (1) "servico_prest" com a Nota Fiscal do rendimento, e (2) "baixa_ser" dando baixa na parcela dessa MESMA nota, pelo valor recebido no banco. Só faça lançamento manual de aplicação se o usuário mandar explicitamente fazer assim nessa empresa.
